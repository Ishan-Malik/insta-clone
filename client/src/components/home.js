        ...
        <div style={{marginLeft:"250px"}}>
           ...
           data.map(item=>{
            return(
             ...
             <img alt="" src={item.postedby.image} style={{width:"50px",borderRadius:"10px",height:"40px",float:"left",marginRight:"10px"}}></img><h4><Link to={item.postedby._id===state._id?'/profile':'/profile/'+item.postedby._id}>{item.postedby.name}</Link></h4>&nbsp;{item.postedby._id===state._id?<i class="material-icons" style={{color:"black",float:"right"}} onClick={()=>{deletePost(item._id)}}>delete</i>:<p></p>}
